...
public class ModSounds {
    ...
    public static final RegistryObject<SoundEvent> EQUIP = registerSoundEvents("equip");
    public static final RegistryObject<SoundEvent> BACKPACK_WARN = registerSoundEvents("backpack_warn");

    public static final RegistryObject<SoundEvent> IMPALE = registerSoundEvents("impale");

    public static final RegistryObject<SoundEvent> SPIDER_DROP = registerSoundEvents("spider_drop");
    public static final RegistryObject<SoundEvent> SPIDER_JUMP = registerSoundEvents("spider_jump");
    public static final RegistryObject<SoundEvent> SPIDER_DIE = registerSoundEvents("spider_die");
